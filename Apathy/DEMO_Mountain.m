...
%--------------------------------------------------------------------------
b1 = 0.6; % Probability of successful leap [0-1] - this parameter gives the probability a leap is successful and is assumed to be the same in the world and generative model
