                        ...
                        for g = 1:Ns(2)
                            if f1==f2 && g==f1
                                if f6>7
                                    ...
                                    A{g}(Ns(3)+1,f1,f2,f3,f6) = a1;       % Color
                                    A{g}(1:Ns(3),f1,f2,f3,f6) = (1-a1)/Ns(3);
                                    A{g+Ns(2)}(Ns(4)+1,f1,f2,f4,f6) = a2; % Shape
                                    A{g+Ns(2)}(1:Ns(4),f1,f2,f4,f6) = (1-a2)/Ns(4);
                                end
                            else
                                A{g}(1:Ns(3)+1,f1,f2,f3,f6) = 1/(Ns(3)+1); % Color
                                A{g+Ns(2)}(1:Ns(4)+1,f1,f2,f4,f6) = 1/(Ns(4)+1); % Shape
                            end
                        end
